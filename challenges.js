...
const billValue = 50;
billValue >= 50 && billValue <= 300 ? console.log(`According to the bill value $${billValue}, the tip you have to leave is $ ${billValue * 0.15}.`) : console.log(`According to the bill value $${billValue}, the tip you have to leave is $ ${billValue * 0.2}.`);
